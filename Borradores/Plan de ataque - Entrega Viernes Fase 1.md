...
```mermaid
flowchart TD
    T17["Propuesta T-017: Completar definiciones y datos faltantes\n(RUTs, perfil egreso, roles, factibilidad, Gantt 18 semanas)"]
    T18["Propuesta T-018: Consolidar y montar Informe Final\n(Plantilla oficial .docx, formato, ortografía, evidencias)"]
    T19["Propuesta T-019: Diseñar Diapositivas y Guión de Presentación\n(Storyline, diapositivas, roles de exposición, preguntas tipo)"]
