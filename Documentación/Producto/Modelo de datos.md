...
El modelo completo sigue en propuesta. La base de locaciones, accesos y bibliotecas se acordó con Tomás el 2026-09-03: sin entidad cliente por ahora, uso inicial por Cristóbal como administrador, operadores previstos para una o varias locaciones y contenido aislado por locación. La temporalidad y la recurrencia de las programaciones todavía requieren definición.
...
- **Temporalidad y recurrencia semanal:** `fecha_inicio`, `fecha_fin`, `hora_inicio` y `hora_fin` existen, pero todavía no definen si el rango se ejecuta diariamente, como una única ventana continua o con otra semántica. No hay selección de días de semana ni repetición semanal modelada.
