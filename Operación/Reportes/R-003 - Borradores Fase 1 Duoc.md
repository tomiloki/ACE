...
```mermaid
flowchart LR
  I["Informe Fase 1"] --> R["Redactado<br/>relevancia, descripción,<br/>objetivos, Gantt"]
  I --> V["Por validar<br/>propuestas de redacción"]
  I --> P["Bloqueado<br/>8 campos"]
  P --> E["Equipo<br/>competencias, metodología,<br/>evidencias, recursos"]
  P --> C["Individual<br/>datos personales,<br/>intereses profesionales"]
```
