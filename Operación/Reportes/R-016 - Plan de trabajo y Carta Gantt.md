...
|---|---|---|---|:---:|---|---|
| **C3.** Aplicar principios de ingeniería de software y especificación formal de requerimientos. | **1.1** Levantamiento de problemática y requerimientos | Reuniones con Cristóbal (Lumina Motion) para relevar dolores operativos en pantallas en locaciones fijas. | Canal de comunicación, minutas de reunión | S1 - S2 (2 sem) | Matías Salas | Requerimientos funcionales y no funcionales base. |
...
| **C2.** Modelar, consultar y administrar bases de datos relacionales y almacenamiento local. | **2.2** Modelado de datos relacional y local | Diseño del esquema de base de datos (locaciones, sectores, pantallas, medios, playlists y programación). | Motor DB, herramientas CASE, SQL | S5 - S6 (2 sem) | Paulo Loyola, Tomás Escalante | Diagrama Entidad-Relación y script DDL. |
...
| **C1.** Diseñar, desarrollar e integrar soluciones de software cliente-servidor y distribuidas. | **3.2** Desarrollo de Backend Core y API REST | Construcción de endpoints para carga de medios, control de pantallas y autenticación. | Laravel, Git | S7 - S9 (3 sem) | Tomás Escalante | Servicios backend funcionales. |
| **C1.** Diseñar, desarrollar e integrar soluciones de software cliente-servidor y distribuidas. | **3.3** Desarrollo de Frontend Admin Web | Construcción de interfaz web reactiva para administración de pantallas y contenido. | Filament v5 sobre Laravel | S8 - S10 (3 sem) | Paulo Loyola | Panel de control web operativo. |
| **C1.** Diseñar, desarrollar e integrar soluciones de software cliente-servidor y distribuidas. | **3.4** Construcción del Player Multimedia base | Desarrollo del reproductor en pantalla para ejecución de listas de medios locales. | Player local; plataforma por definir e IndexedDB | S8 - S10 (3 sem) | Matías Salas, Tomás Escalante | Reproductor base ejecutando video/imagen. |
...
| **C1.** Diseñar, desarrollar e integrar soluciones de software cliente-servidor y distribuidas. | **4.1** Lógica de programación horaria avanzada | Algoritmos de calendarización por horario, fechas, días de semana, sectores y pantallas, bloqueando solapamientos. | Algoritmos de scheduler, Backend | S12 - S13 (2 sem) | Paulo Loyola, Tomás Escalante | Motor de programación horaria integrado. |
| **C1 / C2.** Persistencia y resiliencia offline. | **4.2** Resiliencia offline y almacenamiento local | Almacenamiento local en Player (caché de medios) para reproducción continua sin internet. | IndexedDB y caché local | S12 - S14 (3 sem) | Tomás Escalante, Matías Salas | Player autónomo frente a cortes de red. |
| **C1.** Diseñar, desarrollar e integrar soluciones de software cliente-servidor y distribuidas. | **4.3** Sincronización y telemetría de pantallas | Comunicación bidireccional: descarga de contenidos y reporte de estado (heartbeat). | Laravel Reverb, WebSockets y telemetría básica | S13 - S14 (2 sem) | Tomás Escalante, Paulo Loyola | Sincronización en vivo y monitoreo de salud. |
...
2. **Interrupción prolongada de conexión a internet en locaciones:**
...
1. La matriz se incorporó al informe entregado de [[Documentación/Duoc/Entregas/Entrega 1/README|Entrega 1 Duoc]].
2. La presentación entregada utilizó esta estructura como insumo; su detalle queda en [[R-017 - Narrativa y diseño de diapositivas de la presentación]].
