...
```mermaid
flowchart LR
  A["Fase 1 · 70 pts grupales"] --> B["Cubierto<br/>10 pts"]
  A --> C["Parcial<br/>15 pts"]
  A --> D["Sin información<br/>45 pts"]
  D --> E["Plan de trabajo<br/>y Carta Gantt<br/>20 pts"]
  D --> F["Objetivos, evidencias,<br/>perfil de egreso,<br/>plantilla<br/>25 pts"]
```
